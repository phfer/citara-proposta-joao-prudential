    ...
    <div class="container">
      <header class="topbar">
        <a class="brand" href="${base}Citara Landing.html" aria-label="Cítara, início">
          <img src="${base}assets/logo-horizontal-branco.png" alt="Cítara" style="height: 32px; width: auto; display: block;">
        </a>
        <nav class="nav-links">
      ...
      <div class="footer-inner">
        <div>
          <a class="brand" href="${base}Citara Landing.html">
            <img src="${base}assets/logo-vertical-branco.png" alt="Cítara" style="height: 96px; width: auto; display: block;">
          </a>
